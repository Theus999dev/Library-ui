    ...
    Themes = {
        Darker = {
            ["Color Hub 1"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 70, 140)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 40, 90))
            }),
            ["Color Hub 2"] = Color3.fromRGB(25, 50, 110),
            ["Color Stroke"] = Color3.fromRGB(40, 60, 120),
            ["Color Theme"] = Color3.fromRGB(50, 120, 255),
